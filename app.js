...
function diagram(m){let s=`<svg viewBox="0 0 600 300" role="img" aria-label="두 직선과 횡단선으로 이루어진 각의 그림"><style>.g{stroke:#111827;stroke-width:4;fill:none;stroke-linecap:round}.arc{stroke:#6b7280;stroke-width:2;fill:none}.t{font:700 22px system-ui,sans-serif;fill:#111827;text-anchor:middle;dominant-baseline:middle}.dot{fill:#111827}</style><path class="g" d="M45 105H555M45 205H555M85 270L515 40"/>`;
for(let i=0;i<4;i++)s+=`<path class="arc" d="${arcPath(TOP.x,TOP.y,i)}"/>`;
for(let i=0;i<4;i++)s+=`<path class="arc" d="${arcPath(BOTTOM.x,BOTTOM.y,i)}"/>`;
